...
export const metadata = {
  title: 'Contact Us | Kenya Consultancy',
  description: 'Contact Kenya Consultancy for all your service needs. Call us, email us, or fill out our online form. We respond within 30 minutes.',
};
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="tel:+254700000000" className="text-gray-600 hover:text-primary-600 transition-colors">+254 700 000 000</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:sales@yourdomain.co.ke" className="text-gray-600 hover:text-primary-600 transition-colors">sales@yourdomain.co.ke</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
            ...
            <div className="bg-green-50 border border-green-200 rounded-2xl p-6">
              ...
              <a
                href="https://wa.me/254700000000?text=Hello%2C%20I%20would%20like%20to%20get%20in%20touch"
                target="_blank"
